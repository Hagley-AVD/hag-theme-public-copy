 ...
 */
function hagthemepubliccopy_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL)  {
  // Work-around for a core bug affecting admin themes. See issue #943212.
  if (isset($form_id)) {
    return;
  }
  $form['hagthemepubliccopy_custom'] = array(
    '#type' => 'fieldset',
  ...
  $form['hagthemepubliccopy_custom']['hagthemepubliccopy_front_background'] = array(
    '#type' => 'fieldset',
    '#title' => t('Frontpage background image settings'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['hagthemepubliccopy_custom']['hagthemepubliccopy_front_background']['hag_background_collection_pid'] = array(
    '#type' => 'textfield',
  ...
  $form['hagthemepubliccopy_custom']['hagthemepubliccopy_front_background']['hag_background_dsid'] = array(
    '#type' => 'textfield',
