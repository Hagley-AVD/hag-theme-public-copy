...
function ir7_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL)  {
  ...
  $form['ir7_custom']['ir7_front_background'] = array(
    '#type' => 'fieldset',
    '#title' => t('Frontpage background image settings'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['ir7_custom']['ir7_front_background']['hag_background_collection_pid'] = array(
    '#type' => 'textfield',
  ...
  $form['ir7_custom']['ir7_front_background']['hag_background_dsid'] = array(
    '#type' => 'textfield',
