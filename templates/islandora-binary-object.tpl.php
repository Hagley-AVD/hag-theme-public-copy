  ...
  <div class="islandora-binary-object-content-wrapper clearfix">
    ...
    <?php if (isset($islandora_thumbnail_img)): ?>
      <div class="islandora-binary-object-content">
       <a href="/islandora/object/<?php print $islandora_object->id; ?>/datastream/OBJ/download"><?php print $islandora_thumbnail_img; ?></a>
      </div>
    <?php endif; ?>
    <?php if (isset($islandora_binary_object_info)): ?>
     <div class="binary-object-info"><?php print $islandora_binary_object_info; ?></div>
    <?php endif; ?>
  </div>
